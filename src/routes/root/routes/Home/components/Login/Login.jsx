  ...
  <div id="loginPanel" className="panel panel-default">
    ...
    <div id="loginPanelBody" className="panel-body">
      <form id="loginForm">
        <div className="form-group">
          <input type="text" className="form-control formControls" id="username" placeholder="Όνομα Χρήστη"/>
        </div>
        <div className="form-group">
          <input type="password" className="form-control formControls" id="password" placeholder="Κωδικός"/>
        </div>
    ...
    <ul className="list-group">
      <li id="newUser" className="list-group-item">
        ...
        <button id="newUserButton" className="btn btn-default buttons" type="submit">Αίτηση Εγγραφής</button>
      </li>
    </ul>
  </div>
)
